...
const SettingRow = ({ icon: Icon, label, value, onClick, danger = false, badge }) => (
    ...
    >
        <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${danger ? "bg-red-500/10" : "bg-white/5"
            }`}>
            <Icon size={18} className={danger ? "text-red-400" : "text-gray-400 group-hover:text-white"} />
        </div>
    ...
    return (
        <div className="space-y-8">
            ...
            <motion.div
                ...
                className="bg-gradient-to-br from-[#1E2128] to-[#1A1D23] border border-white/5 rounded-[28px] p-6 flex items-center gap-5"
            >
                ...
                <div className="flex-1 min-w-0">
                    <h2 className="text-xl font-black text-white truncate">{rider?.name || "Rider"}</h2>
                    <p className="text-sm text-gray-400 font-medium mt-0.5">{rider?.phone || "—"}</p>
                ...
                <button
                    ...
                    className="w-10 h-10 bg-white/5 hover:bg-white/10 rounded-xl flex items-center justify-center text-gray-400 transition-colors shrink-0"
                >
                    <Edit3 size={16} />
                </button>
            </motion.div>
            ...
            <motion.div
                ...
                className="bg-[#1A1D23] border border-white/5 rounded-3xl overflow-hidden"
            >
            ...
            >
                ...
                <div className="flex items-center gap-4 p-4 rounded-2xl">
                    ...
                    <button
                        ...
                        className={`relative w-12 h-6 rounded-full transition-colors ${notifications ? "bg-orange-600" : "bg-white/10"}`}
                    >
