    ...
    return (
        <ProtectedRoute>
            <div className="bg-zinc-50 dark:bg-zinc-950 min-h-screen font-display pb-20">
                <div className="sticky top-0 z-10 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md border-b border-zinc-100 dark:border-zinc-800 px-4 py-4">
                    <div className="max-w-md mx-auto flex items-center gap-4">
                        <BackButton />
                        <h1 className="text-lg font-bold text-zinc-800 dark:text-white">My Reviews</h1>
                    </div>
                </div>
                ...
                <div className="max-w-md mx-auto p-4 space-y-4">
                    ...
                    {loading ? (
                        ...
                        Array.from({ length: 3 }).map((_, i) => (
                            <div key={i} className="bg-white dark:bg-zinc-900 p-4 rounded-2xl border border-zinc-100 dark:border-zinc-800 space-y-3 animate-pulse">
                                ...
                                <div className="h-16 w-full bg-zinc-100 dark:bg-zinc-800 rounded-xl" />
                        ...
                        <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-zinc-800 dark:text-white">No reviews yet</h3>
                                <p className="text-zinc-500 dark:text-zinc-400 text-sm mt-1 max-w-[200px] mx-auto">
                        ...
                        reviews.map((review) => (
                            <div
                                key={review._id}
                                className="bg-white dark:bg-zinc-900 p-5 rounded-2xl border border-zinc-100 dark:border-zinc-800 shadow-sm hover:shadow-md transition-shadow"
                            >
                                <div className="flex justify-between items-start mb-3">
                                    <div className="space-y-1">
                                        ...
                                        {review.foodId && (
                                            <div className="flex items-center gap-2 pl-1">
                                                <Utensils size={12} className="text-zinc-400 dark:text-zinc-500" />
                                    ...
                                    <div className="flex items-center gap-1 bg-orange-50 dark:bg-orange-500/10 px-2 py-1 rounded-lg border border-orange-100 dark:border-orange-500/20">
                                ...
                                <div className="bg-zinc-50 dark:bg-zinc-800 p-3 rounded-xl mb-3">
