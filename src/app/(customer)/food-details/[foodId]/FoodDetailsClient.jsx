                          ...
                          <div className="w-full h-[180px] md:h-[220px] rounded-[24px] overflow-hidden relative">
                            ...
                            <div className="absolute top-2.5 left-2.5 pr-4 flex flex-wrap gap-1.5 z-10">
                              ...
                              {food.dietary_type && food.dietary_type !== "mixed" && (
                                <div className={`text-[10px] font-semibold px-3 py-1 rounded-full uppercase tracking-widest border border-white/20 backdrop-blur-md ${food.dietary_type === "veg" || food.dietary_type === "vegan"
                            ...
                            {food.combos.map((combo, i) => (
                              ...
                              >
                                ...
                                <button
                                  ...
                                  className={`w-auto px-4 py-2 shrink-0 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${(!combo.is_available || !itemAvailability.available)
