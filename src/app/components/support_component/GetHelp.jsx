  ...
  return (
    <div className="bg-slate-50 min-h-screen">
          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            >
              ...
              <input
                ...
                className="w-full bg-white rounded-2xl py-4 pl-12 pr-4 text-sm font-medium shadow-2xl shadow-orange-900/20 focus:ring-4 focus:ring-orange-500/20 outline-none transition-all"
              />
            </motion.div>
          </div>
        </div>
      ...
      <main className="max-w-4xl mx-auto px-6 -mt-10 pb-20">
        ...
        {/* Support Tip */}
        <section className="bg-orange-50 rounded-[32px] p-8 text-center border border-orange-100">
          <h3 className="text-lg font-bold text-orange-600 mb-2">Available 24/7</h3>
          <p className="text-sm font-medium text-orange-900/60 max-w-xs mx-auto">
