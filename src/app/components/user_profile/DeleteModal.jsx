      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 w-full max-w-sm text-center relative z-10 shadow-2xl border border-gray-100 dark:border-slate-800"
          >
            ...
            <p className="text-sm font-medium text-gray-400 dark:text-slate-400 mb-8 px-4 leading-relaxed">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button
                onClick={() => setIsDeleteModalOpen(false)}
                className="bg-gray-50 dark:bg-slate-800 text-gray-500 dark:text-slate-400 py-4 rounded-2xl font-bold hover:bg-gray-100 dark:hover:bg-slate-700 active:scale-[0.98] transition-all"
              >
                No, Keep It
              </button>
            </div>
