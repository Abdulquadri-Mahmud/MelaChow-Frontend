        ...
        >
            ...
            <div className="flex-1 min-w-0 space-y-0.5">
                <div className="flex items-center gap-1.5">
                    <h3 className="text-[13px] font-extrabold text-zinc-900 dark:text-white tracking-tight truncate group-hover:text-orange-600 transition-colors duration-200 uppercase italic">
                        {food.name}
                    </h3>
                    {food.is_popular && <Flame size={11} className="text-orange-500 shrink-0 animate-pulse" />}
                </div>
 
                <p className="text-[9px] text-zinc-400 dark:text-zinc-500 font-black uppercase tracking-widest truncate mb-0.5">
                    {vendor?.storeName} • {vendor?.city || vendor?.address?.city || "Nearby"}
                </p>
 
                <p className="text-[10px] text-zinc-500 dark:text-zinc-400 line-clamp-2 leading-relaxed font-medium">
            ...
            <div className="relative w-[70px] h-[70px] rounded-xl overflow-hidden shrink-0 bg-zinc-100 dark:bg-zinc-800 shadow-md group-hover:shadow-orange-200 dark:group-hover:shadow-orange-900/30 transition-shadow duration-300">
                ...
                {!isUnavailable && (
                    <div className="absolute bottom-1 right-1">
                        <div className="w-7 h-7 bg-orange-500 rounded-lg flex items-center justify-center text-white shadow-lg shadow-orange-500/40 group-active:scale-90 transition-transform">
                ...
                {isUnavailable && (
                    <div className="absolute inset-0 bg-zinc-900/50 backdrop-blur-[1px] flex items-center justify-center">
                        <span className="bg-white/95 px-1.5 py-0.5 rounded text-[8px] font-black uppercase tracking-widest text-zinc-800">
                            Sold Out
                        </span>
                    </div>
                )}
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 pb-20 selection:bg-orange-500/30">
        ...
        <div className="max-w-xl mx-auto px-4 py-1.5">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex flex-col items-center">
                <span className="text-[8px] font-black uppercase text-orange-500 tracking-[0.2em] italic opacity-70 leading-none mb-0.5">Explore</span>
                <h1 className="text-md font-black text-zinc-900 dark:text-zinc-100 uppercase italic tracking-tighter leading-none">Cravings</h1>
            </div>
      ...
      <div className="max-w-xl mx-auto px-2 pt-2.5">
          <motion.div 
            ...
            className="flex items-end justify-between border-b border-zinc-200/50 dark:border-zinc-800 pb-1.5"
          >
              <div className="flex flex-col">
                  <span className="text-[9px] font-black uppercase text-zinc-400 tracking-widest leading-none mb-0.5">
                      {query ? `Results for "${query}"` : 'Discovery Feed'}
                  </span>
                  <p className="text-xs font-black text-zinc-900 dark:text-white italic tracking-tighter">
          ...
          <div className="space-y-4 pb-24 px-4 overflow-hidden">
            <AnimatePresence mode="popLayout">
                ...
                >
                    ...
                    {/* Categories serve heading removed as per user instruction */}
