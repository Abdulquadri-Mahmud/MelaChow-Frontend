                    ...
                    <div className="flex flex-col gap-6">
                        {filteredFoods.map((food) => (
                            <div
                                ...
                                className="bg-white dark:bg-zinc-900 rounded-[2.5rem] p-2.5 flex border border-transparent shadow-sm hover:shadow-xl hover:shadow-zinc-200/40 dark:hover:shadow-none hover:border-orange-600/10 transition-all cursor-pointer group hover:-translate-y-1 active:scale-[0.98]"
                            >
                                {/* Image Section */}
                                <div className="relative w-32 h-32 rounded-[2.25rem] overflow-hidden flex-shrink-0">
                                    <img
