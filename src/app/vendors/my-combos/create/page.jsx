...
export default function CreateComboPage() {
  ...
  return (
    <div className="min-h-screen dark:p-3 p-0 bg-zinc-50 dark:bg-zinc-950 pb-32 transition-colors">
        ...
        <div className="mb-6 bg-white dark:bg-zinc-900 p-4 rounded-2xl border border-zinc-100 dark:border-zinc-800 flex items-start justify-between gap-4">
          <div>
            <div className="flex gap-3 items-center mb-2">
                <BackButton label="" className="h-9 w-9 flex items-center justify-center rounded-lg bg-zinc-50 dark:bg-zinc-800 text-zinc-400 hover:text-orange-600 transition-colors" />
            ...
            <p className="text-xs font-medium text-zinc-500 dark:text-zinc-400 max-w-2xl leading-relaxed">
      ...
      {/* FIXED FOOTER */}
      <div className="fixed bottom-0 left-0 right-0 z-[60] p-3 lg:p-4 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-xl border-t border-zinc-100 dark:border-zinc-800">
