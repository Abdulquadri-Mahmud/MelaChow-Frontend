    ...
    <div className="h-screen w-full bg-white dark:bg-slate-900 flex items-center justify-center overflow-hidden p-4">
      ...
      >
        ...
        <div className="mt-4 pt-4 border-t border-slate-50 dark:border-slate-800 text-center space-y-4">
          ...
          <Link
            href="/auth/signin"
            className="inline-block p-1 bg-slate-50 dark:bg-slate-800 rounded-xl px-4 border border-slate-100 dark:border-slate-700 text-[9px] font-black uppercase text-slate-400 hover:text-orange-500 hover:border-orange-500/20 transition-all tracking-[0.2em]"
          >
        ...
        {message && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-slate-900 rounded-[32px] p-8 w-full max-w-sm text-center shadow-2xl relative "
            >
              <button
                onClick={() => setMessage("")}
              ...
              <p className="text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-tight leading-relaxed">{message}</p>

              <button
                onClick={() => setMessage("")}
                className="mt-8 w-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 py-4 rounded-2xl font-black uppercase italic tracking-widest hover:scale-[1.02] active:scale-95 transition-all shadow-lg"
              >
                Dismiss
              </button>
            </motion.div>
